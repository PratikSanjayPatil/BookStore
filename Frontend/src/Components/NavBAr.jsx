        ...
        <>
            <div
                className={` max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${sticky
                    ? "sticky navbar shadow-md bg-base-200 dark:bg-slate-600 dark:text-white duration-300 transitionn-all ease-in-out"
                    : ""
                    }`}
            >
                    ...
                    <div className="navbar-end space-x-3">
                        <div className="navbar-center hidden lg:flex">
                            ...
                            <label className="px-3 py-2 border rounded-md flex items-center gap-2">
                                <input type="text" className="grow outline-none" placeholder="Search" onChange={handleSearch}/>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 16 16"
                                    fill="currentColor"
