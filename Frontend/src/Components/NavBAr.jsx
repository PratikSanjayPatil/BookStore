    ...
    <>
        <div 
            className={` max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 ${
                sticky
                    ?"sticky navbar shadow-md bg-base-200 duration-300 transitionn-all ease-in-out"
                    :""
                }`}
        >
            <div className="navbar bg-base-100">
                ...
                <div className="navbar-end space-x-3">
                    ...
                    <a className="bg-black text-white px-3 py-2 rounded-md hover:bg-slate-800 duration-300">Button</a>
                </div>
            </div>
        </div>
    </>
